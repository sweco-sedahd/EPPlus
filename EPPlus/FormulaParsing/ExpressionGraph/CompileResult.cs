...
namespace OfficeOpenXml.FormulaParsing.ExpressionGraph
{
    public class CompileResult
    {
        ...
        public static CompileResult Empty { get; } = new(null, DataType.Empty);
        ...
        public object ResultValue
        {
            get
            {
                if (Result is not ExcelDataProvider.IRangeInfo r)
                {
                    return Result;
                }
        ...
        public double ResultNumeric
        {
            get
            {
                ...
                if (_ResultNumeric == null)
                {
                    ...
                    {
                        ExcelDataProvider.ICellInfo c = ((ExcelDataProvider.IRangeInfo)Result).FirstOrDefault();
                        if (c == null)
                        {
                            return 0;
                        }
        ...
        public bool IsNumericString
        {
            get
            {
                if (DataType == DataType.String && ConvertUtil.TryParseNumericString(Result, out double result))
                {
