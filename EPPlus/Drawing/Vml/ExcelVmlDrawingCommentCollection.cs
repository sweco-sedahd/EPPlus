...
namespace OfficeOpenXml.Drawing.Vml
{
    internal class ExcelVmlDrawingCommentCollection : ExcelVmlDrawingBaseCollection, IEnumerable
    {
        ...
        protected void AddDrawingsFromXml(ExcelWorksheet ws)
        {
            ...
            list.Sort((r1, r2) => r1.RangeID < r2.RangeID ? -1 : r1.RangeID > r2.RangeID ? 1 : 0); //Vml drawings are not sorted. Sort to avoid missmatches.
        ...
        private XmlNode AddDrawing(ExcelRangeBase cell)
        {
            ...
            ulong id = ExcelCellBase.GetCellID(cell.Worksheet.SheetID, cell._fromRow, cell._fromCol);
            int ix = _drawings.IndexOf(id);
