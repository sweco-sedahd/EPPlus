...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public class ExcelChart : ExcelDrawing
    {
        ...
        internal static ExcelChart GetChart(ExcelDrawings drawings, XmlNode node /*, XmlNode chartTypeNode*/)
        {
            ...
            if (chartNode != null)
            {
                ...
                foreach (XmlElement n in chartXml.SelectSingleNode(rootPath, drawings.NameSpaceManager).ChildNodes)
                {
                    ...
                    {
                        ExcelChart subChart = GetChart(n, null, null, null, null, null, topChart);
                        if (subChart != null)
                        {
        ...
        private void Init(ExcelDrawings drawings, XmlNode chartNode)
        {
            ...
            _chartXmlHelper.SchemaNodeOrder = new[] { "ofPieType", "title", "pivotFmt", "autoTitleDeleted", "view3D", "floor", "sideWall", "backWall", "plotArea", "wireframe", "barDir", "grouping", "scatterStyle", "radarStyle", "varyColors", "ser", "dLbls", "bubbleScale", "showNegBubbles", "dropLines", "upDownBars", "marker", "smooth", "shape", "legend", "plotVisOnly", "dispBlanksAs", "gapWidth", "showDLblsOverMax", "overlap", "bandFmts", "axId", "spPr", "printSettings" };
        ...
        private void CreateNewChart(ExcelDrawings drawings, eChartType type, ExcelChart topChart)
        {
            if (topChart == null)
            {
                ...
                ZipPackageRelationship chartRelation = drawings.Part.CreateRelationship(UriHelper.GetRelativeUri(drawings.UriDrawing, UriChart), TargetMode.Internal, ExcelPackage.schemaRelationships + "/chart");
        ...
        private string GetChartSerieStartXml(eChartType type, int axID, int xAxID, int serAxID)
        {
            ...
            if (ChartType is eChartType.BarStacked100 or eChartType.BarStacked or eChartType.ColumnStacked or eChartType.ColumnStacked100)
            {
        ...
        {
            if (type is eChartType.XYScatter or eChartType.XYScatterLines or eChartType.XYScatterLinesNoMarkers or eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers)
            {
        ...
        {
            if (type is eChartType.Radar or eChartType.RadarFilled or eChartType.RadarMarkers)
            {
        ...
        {
            if (type is eChartType.Doughnut or eChartType.DoughnutExploded)
            {
        ...
        {
            if (type is eChartType.LineMarkers or eChartType.LineMarkersStacked or eChartType.LineMarkersStacked100 /*||
        ...
        {
            return chartType is eChartType.Area3D or eChartType.AreaStacked3D or eChartType.AreaStacked1003D or eChartType.BarClustered3D or eChartType.BarStacked3D or eChartType.BarStacked1003D or eChartType.Column3D or eChartType.ColumnClustered3D or eChartType.ColumnStacked3D or eChartType.ColumnStacked1003D or eChartType.Line3D or eChartType.Pie3D or eChartType.PieExploded3D or eChartType.ConeBarClustered or eChartType.ConeBarStacked or eChartType.ConeBarStacked100 or eChartType.ConeCol or eChartType.ConeColClustered or eChartType.ConeColStacked or eChartType.ConeColStacked100 or eChartType.CylinderBarClustered or eChartType.CylinderBarStacked or eChartType.CylinderBarStacked100 or eChartType.CylinderCol or eChartType.CylinderColClustered or eChartType.CylinderColStacked or eChartType.CylinderColStacked100 or eChartType.PyramidBarClustered or eChartType.PyramidBarStacked or eChartType.PyramidBarStacked100 or eChartType.PyramidCol or eChartType.PyramidColClustered or eChartType.PyramidColStacked or eChartType.PyramidColStacked100 or eChartType.Surface or eChartType.SurfaceTopView or eChartType.SurfaceTopViewWireframe or eChartType.SurfaceWireframe;
        }
        ...
        {
            return ChartType is eChartType.Line or eChartType.LineMarkers or eChartType.LineMarkersStacked100 or eChartType.LineStacked or eChartType.LineStacked100 or eChartType.Line3D;
        }

        protected bool IsTypeScatterBubble()
        {
            return ChartType is eChartType.XYScatter or eChartType.XYScatterLines or eChartType.XYScatterLinesNoMarkers or eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers or eChartType.Bubble or eChartType.Bubble3DEffect;
        }

        protected bool IsTypeSurface()
        {
            return ChartType is eChartType.Surface or eChartType.SurfaceTopView or eChartType.SurfaceTopViewWireframe or eChartType.SurfaceWireframe;
        }
        ...
        {
            return ChartType is eChartType.AreaStacked100 or eChartType.BarStacked100 or eChartType.BarStacked1003D or eChartType.ColumnStacked100 or eChartType.ColumnStacked1003D or eChartType.ConeBarStacked100 or eChartType.ConeColStacked100 or eChartType.CylinderBarStacked100 or eChartType.CylinderColStacked or eChartType.LineMarkersStacked100 or eChartType.LineStacked100 or eChartType.PyramidBarStacked100 or eChartType.PyramidColStacked100;
        }

        protected internal bool IsTypeStacked()
        {
            return ChartType is eChartType.AreaStacked or eChartType.AreaStacked3D or eChartType.BarStacked or eChartType.BarStacked3D or eChartType.ColumnStacked3D or eChartType.ColumnStacked or eChartType.ConeBarStacked or eChartType.ConeColStacked or eChartType.CylinderBarStacked or eChartType.CylinderColStacked or eChartType.LineMarkersStacked or eChartType.LineStacked or eChartType.PyramidBarStacked or eChartType.PyramidColStacked;
        }

        protected bool IsTypeClustered()
        {
            return ChartType is eChartType.BarClustered or eChartType.BarClustered3D or eChartType.ColumnClustered3D or eChartType.ColumnClustered or eChartType.ConeBarClustered or eChartType.ConeColClustered or eChartType.CylinderBarClustered or eChartType.CylinderColClustered or eChartType.PyramidBarClustered or eChartType.PyramidColClustered;
        }

        protected internal bool IsTypePieDoughnut()
        {
            return ChartType is eChartType.Pie or eChartType.PieExploded or eChartType.PieOfPie or eChartType.Pie3D or eChartType.PieExploded3D or eChartType.BarOfPie or eChartType.Doughnut or eChartType.DoughnutExploded;
        }
        ...
        private void CheckRemoveAxis(ExcelChartAxis excelChartAxis)
        {
            if (ExistsAxis(excelChartAxis))
            {
                ...
                int pos = 0;
                foreach (ExcelChartAxis ax in Axis)
                {
