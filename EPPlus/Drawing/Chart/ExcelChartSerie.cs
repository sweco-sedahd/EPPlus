...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public class ExcelChartSerie : XmlHelper
    {
            ...
            : base(ns, node)
        {
            ...
            _node = node;
            _ns = ns;
            SchemaNodeOrder = new[] { "idx", "order", "spPr", "tx", "marker", "trendline", "explosion", "invertIfNegative", "dLbls", "cat", "val", "xVal", "yVal", "bubbleSize", "bubble3D", "smooth" };

            if (chartSeries.Chart.ChartType is eChartType.XYScatter or eChartType.XYScatterLines or eChartType.XYScatterLinesNoMarkers or eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers or eChartType.Bubble or eChartType.Bubble3DEffect)
            {
