...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public class ExcelChartSeries : XmlHelper, IEnumerable
    {
        ...
        readonly List<ExcelChartSerie> _list = new();
            ...
            : base(ns, node)
        {
            ...
            _node = node;
            _isPivot = isPivot;
            SchemaNodeOrder = new[] { "view3D", "plotArea", "barDir", "grouping", "scatterStyle", "varyColors", "ser", "explosion", "dLbls", "firstSliceAng", "holeSize", "shape", "legend", "axId" };
            foreach (XmlNode n in node.SelectNodes("c:ser", ns))
            {
                ...
                else if (chart.ChartNode.LocalName is "pieChart" or "ofPieChart" or "pie3DChart" or "doughnutChart")
                {
        ...
        protected internal ExcelChartSerie AddSeries(string SeriesAddress, string XSeriesAddress, string bubbleSizeAddress)
        {
            ...
            switch (Chart.ChartType)
            {
                ...
                case eChartType.LineStacked100:
                    ...
                    if (Chart.ChartType is eChartType.LineMarkers or eChartType.LineMarkersStacked or eChartType.LineMarkersStacked100)
                    {
        ...
        {
            if (chartType is eChartType.Line or eChartType.LineStacked or eChartType.LineStacked100 or eChartType.XYScatterLines or eChartType.XYScatterSmooth or eChartType.XYScatterLinesNoMarkers or eChartType.XYScatterSmoothNoMarkers)
            {
        ...
        {
            if (chartType is eChartType.XYScatter or eChartType.XYScatterLines or eChartType.XYScatterLinesNoMarkers or eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers or eChartType.Bubble or eChartType.Bubble3DEffect)
            {
