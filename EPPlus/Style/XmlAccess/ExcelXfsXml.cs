...
namespace OfficeOpenXml.Style.XmlAccess
{
    ...
    public sealed class ExcelXfs : StyleXmlHelper
    {
        ...
        internal override string Id => XfId + "|" + NumberFormatId + "|" + FontId + "|" + FillId + "|" + BorderId + VerticalAlignment + "|" + HorizontalAlignment + "|" + WrapText + "|" + ReadingOrder + "|" + isBuildIn + TextRotation + Locked + Hidden + ShrinkToFit + Indent + QuotePrefix;
        ...
        private int GetIdBorder(eStyleClass styleClass, eStyleProperty styleProperty, object value)
        {
            ...
            string id = border.Id;
            int subId = _styles.Borders.FindIndexByID(id);
        ...
        private void SetBorderItem(ExcelBorderItemXml excelBorderItem, eStyleProperty styleProperty, object value)
        {
            ...
            else if (styleProperty is eStyleProperty.Color or eStyleProperty.Tint or eStyleProperty.IndexedColor)
            {
        ...
        private int GetIdFill(eStyleClass styleClass, eStyleProperty styleProperty, object value)
        {
            ...
            string id = fill.Id;
            int subId = _styles.Fills.FindIndexByID(id);
            if (subId == int.MinValue)
            {
        ...
        private int GetIdFont(eStyleProperty styleProperty, object value)
        {
            ...
            string id = fnt.Id;
            int subId = _styles.Fonts.FindIndexByID(id);
            if (subId == int.MinValue)
            {
        ...
        {
            TopNode = topNode;
            bool doSetXfId = !isCellStyleXsf && XfId > int.MinValue && _styles.CellStyleXfs.Count > 0 && _styles.CellStyleXfs[XfId].newID > int.MinValue;
            if (_numFmtId >= 0)
            {
            ...
            if (ReadingOrder != ExcelReadingOrder.ContextDependent) SetXmlNodeString(readingOrderPath, ((int)ReadingOrder).ToString());
