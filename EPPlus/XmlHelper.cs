...
namespace OfficeOpenXml
{
    ...
    public abstract class XmlHelper
    {
        ...
        internal void SetXmlNodeBool(string path, bool value, bool removeIf)
        {
            if (value == removeIf)
            {
                ...
                if (node != null)
                {
                    if (node is XmlAttribute)
                    {
                        XmlElement elem = (node as XmlAttribute).OwnerElement;
        ...
        {
            if (int.TryParse(GetXmlNodeString(path), NumberStyles.Number, CultureInfo.InvariantCulture, out int i))
            {
                return i;
            }
        ...
        {
            if (decimal.TryParse(GetXmlNodeString(path), NumberStyles.Any, CultureInfo.InvariantCulture, out decimal d))
            {
                return d;
            }
