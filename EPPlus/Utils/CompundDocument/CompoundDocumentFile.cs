...
namespace OfficeOpenXml.Utils.CompundDocument
{
    ...
    internal class CompoundDocumentFile : IDisposable
    {
        ...
        public void Write(MemoryStream ms)
        {
            ...
            WritePosition(bw, new[] { FAT_SECTOR, END_OF_CHAIN, END_OF_CHAIN }, ref _currentFATSectorPos); //First sector is first FAT sector, second is First Dir sector, thirs is first Mini FAT sector.
