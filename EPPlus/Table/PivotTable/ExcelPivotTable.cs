...
namespace OfficeOpenXml.Table.PivotTable
{
    ...
    public class ExcelPivotTable : XmlHelper
    {
        ...
        ExcelPivotCacheDefinition _cacheDefinition;
            ...
            base(sheet.NameSpaceManager)
        {
            ...
            Relationship = sheet.Part.CreateRelationship(UriHelper.ResolvePartUri(sheet.WorksheetUri, PivotTableUri), TargetMode.Internal, ExcelPackage.schemaRelationships + "/pivotTable");

            _cacheDefinition = new ExcelPivotCacheDefinition(sheet.NameSpaceManager, this, sourceAddress, tblId);
            _cacheDefinition.Relationship = Part.CreateRelationship(UriHelper.ResolvePartUri(PivotTableUri, _cacheDefinition.CacheDefinitionUri), TargetMode.Internal, ExcelPackage.schemaRelationships + "/pivotCacheDefinition");
        ...
        private void init()
        {
            SchemaNodeOrder = new[] { "location", "pivotFields", "rowFields", "rowItems", "colFields", "colItems", "pageFields", "pageItems", "dataFields", "dataItems", "formats", "pivotTableStyleInfo" };
        }
        ...
        private void LoadFields()
        {
            ...
            {
                ExcelPivotTableField fld = Fields[index++];
        ...
        public TableStyles TableStyle
        {
            ...
            set
            {
                ...
                {
                    SetXmlNodeString(STYLENAME_PATH, "PivotStyle" + value);
                }
            }
        }
